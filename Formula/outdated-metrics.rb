class OutdatedMetrics < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/ElevatePartners/outdated-metrics/releases/download/v1.1.0/outdated-metrics-macos-arm64.tar.gz"
    ...
    on_intel do
      url "https://github.com/ElevatePartners/outdated-metrics/releases/download/v1.1.0/outdated-metrics-macos-x64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/ElevatePartners/outdated-metrics/releases/download/v1.1.0/outdated-metrics-linux-arm64.tar.gz"
    ...
    on_intel do
      url "https://github.com/ElevatePartners/outdated-metrics/releases/download/v1.1.0/outdated-metrics-linux-x64.tar.gz"
